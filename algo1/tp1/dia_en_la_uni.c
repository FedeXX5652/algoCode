...
void qst_3(int* qst_score){
    ...
    // Verifico la respuesta con las condiciones dadas y re pregunto en caso de no ser correcta
    while(decimal < 0.0 || decimal > 0.59 || integer < 0 || integer > 23){
    ...
    Post condiciones:
        - Asigna un caracter por referencia a la variable score alocada en el main
            + Si el final_score es mayor o igual a 13 y menor o igual a 41
                · Si ans_3_score es igual a 0 (llega temprano), asigna el personaje de Stitch a character
                · Si ans_3_score es igual a 1 (llega tarde), asigna el personaje de Olaf a character
            + Si el final_score es mayor o igual a 42 y menor o igual a 68
                · Si ans_3_score es igual a 0 (llega temprano), asigna el personaje de Jasmin a character
                · Si ans_3_score es igual a 1 (llega tarde), asigna el personaje de Rayo a character
*/
void character_selector(int final_score, char* character, int ans_3_score){
...
int main(){
    ...
    character_selector(ans_1_score+(ans_2_score+ans_4_score), &character, ans_3_score);
